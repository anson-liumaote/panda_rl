...
def main():
    ...
    joint_file = 'scripts/motion_converter/data/joint_angles_20250228_140351_resampled_reordered.txt'
    endpoint_file = 'scripts/motion_converter/data/joint_angles_20250228_140351_resampled_reordered_foot_endpoints.txt'  # Adjust this to match your endpoint file name

...
class SpotObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        current_step = ObsTerm(func=spot_mdp.motion_sequence_counter, params={"asset_cfg": SceneEntityCfg("robot"), "max_count":79})
...
class SpotRewardsCfg:
    ...
    animation_pos = RewardTermCfg(
        ...
        params={
            ...
            "file_path":f"{ISAACLAB_ASSETS_DATA_DIR}/Animation/walk_re/joint_positions_20250327_180705.txt"
        },
    )
    ...
    animation_vel = RewardTermCfg(
        ...
        params={
            ...
            "asset_cfg": SceneEntityCfg("robot", joint_names=".*"),
            "velocity_threshold": 0.1,
            "file_path":f"{ISAACLAB_ASSETS_DATA_DIR}/Animation/walk_re/joint_velocities_20250327_180705.txt"
        },
    )
    ...
    foot_end_point = RewardTermCfg(
        ...
        params={
            "std": 0.5,
            "asset_cfg": SceneEntityCfg("robot", body_names=".*foot"),
            "file_path":f"{ISAACLAB_ASSETS_DATA_DIR}/Animation/walk_re/foot_endpoints_20250327_180705.txt"
        },
    )
    ...
    # root_height_z = RewardTermCfg(
    #     func=spot_mdp.root_height_penalty, weight=-1.0, params={"asset_cfg": SceneEntityCfg("robot"), "target_height":0.2}
    # ) 
